...
?>
    ...
    <h2>Student Registration</h2>
        <div class="row">
            <div >
                <form action="studentinsert.php" method="POST"> <!-- Make sure to set the correct action URL -->
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="enrollment_date" name="enrollment_date" placeholder="Enrollment Date">
                    </div>
